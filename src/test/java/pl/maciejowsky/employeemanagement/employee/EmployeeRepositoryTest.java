...
//        //when
//        Employee result = underTest.findEmployeeAndInfoByEmail(exemplaryEmail).get();
//
//        //then
...
//        Employee result = underTest.findEmployeeAndInfoById(2L).get();
//
//        //then
//
...
//
//        //when
//        Employee result = underTest.findEmployeeAndInfoById(1L).get();
//
//        //then
//
//        assertThat(result).isNull();
